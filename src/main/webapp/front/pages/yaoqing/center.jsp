    ...
    <ul class="layui-nav layui-nav-tree">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="mianshiTime" id="mianshiTime"  lay-verify="required|date"   placeholder="面试时间" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="mianshiAddress" id="mianshiAddress" lay-verify="required" placeholder="面试地点" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="mianshiText" id="mianshiText" lay-verify="required" placeholder="面试需知" autocomplete="off" class="layui-input">
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`yaoqing/session`, 'get', {}, function (data) {
                    // 表单赋值
