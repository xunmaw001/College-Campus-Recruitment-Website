                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="jianliUuidNumber" id="jianliUuidNumber" placeholder="简历唯一编号" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="jianliName" id="jianliName" placeholder="简历名称" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    ...
    // 当前表的字典表
        ...
        function jianliSexTypesSelect() {
            http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=jianli_sex_types", 'get', {}, function (res) {
                if(res.code == 0){
        ...
        function pageList() {
            ...
            if (jquery('#jianliUuidNumber').val() != null && jquery('#jianliUuidNumber').val() != "" && jquery('#jianliUuidNumber').val() != "null" ) {
                param['jianliUuidNumber'] = jquery('#jianliUuidNumber').val();
            }
         
            if (jquery('#jianliName').val() != null && jquery('#jianliName').val() != "" && jquery('#jianliName').val() != "null" ) {
                param['jianliName'] = jquery('#jianliName').val();
            }
            ...
            // 获取列表数据
            http.request('jianli/list', 'get', param, function(res) {
