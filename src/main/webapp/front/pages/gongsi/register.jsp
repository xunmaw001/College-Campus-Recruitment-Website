                ...
                <div class="layui-form-item layui-form-text input">
                  ...
                  <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="gongsiName" id="gongsiName"  placeholder="公司名称"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">所在行业:</span>
                        <div class="layui-input-inline">
                            <select name="hanyeTypes" id="hanyeTypes" lay-filter="hanyeTypes" style="width: 600px;">
...
<!-- 手机号 -->
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="gongsiPhone" id="gongsiPhone"  lay-verify="phone|required"   placeholder="联系方式" autocomplete="off" class="layui-input" style="width: 400px;">
                        </div>
                    </div>
                </div>
  <!-- 邮箱 -->
                <div class="layui-form-item" pane>
                    <div class="layui-inline" >
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="gongsiEmail" id="gongsiEmail"  lay-verify="email|required"   placeholder="邮箱" autocomplete="off" class="layui-input" style="width: 400px;">
                        </div>
                    </div>
                </div>
