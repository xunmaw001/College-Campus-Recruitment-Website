                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="gongsiName" id="gongsiName" placeholder="公司名称" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    ...
    // 当前表的字典表
        ...
        function hanyeTypesSelect() {
            http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=hanye_types", 'get', {}, function (res) {
                if(res.code == 0){
        ...
        function pageList() {
            ...
            if (jquery('#gongsiName').val() != null && jquery('#gongsiName').val() != "" && jquery('#gongsiName').val() != "null" ) {
                param['gongsiName'] = jquery('#gongsiName').val();
            }
         
            var hanyeTypes = $("#hanyeTypes").find("option:selected").val();
            if (hanyeTypes != null && hanyeTypes != "" && hanyeTypes != "null") {
                param['hanyeTypes'] = hanyeTypes;
            }
                                                

            // 获取列表数据
            http.request('gongsi/list', 'get', param, function(res) {
