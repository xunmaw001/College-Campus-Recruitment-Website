        ...
        <div class="ng-inmod ng-fault ng-paddor ng-bg-fff">
            <div class="ng-inmod-ini">
                    <div class="index_titlebox">
                        <h3 class="index_title">学生就业信息展示</h3>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          <label class="layui-form-label">就业编号</label>
                          <div class="layui-input-inline">
                              <input type="text" name="xueshengjiuyeUuidNumber" id="xueshengjiuyeUuidNumber" placeholder="就业编号" autocomplete="off" class="layui-input">
                          </div>
                      </div>
     
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          <label class="layui-form-label">就业地点</label>
                          <div class="layui-input-inline">
                              <input type="text" name="xueshengjiuyeAddress" id="xueshengjiuyeAddress" placeholder="就业地点" autocomplete="off" class="layui-input">
                          </div>
                      </div>
     
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          <label class="layui-form-label">就业公司</label>
                          <div class="layui-input-inline">
                              <input type="text" name="xueshengjiuyeGongsi" id="xueshengjiuyeGongsi" placeholder="就业公司" autocomplete="off" class="layui-input">
                          </div>
                      </div>
     
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          <label class="layui-form-label">就业职位</label>
                          <div class="layui-input-inline">
                              <input type="text" name="xueshengjiuyeZhiwei" id="xueshengjiuyeZhiwei" placeholder="就业职位" autocomplete="off" class="layui-input">
                          </div>
                      </div>
     
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          <label class="layui-form-label">就业薪资/月</label>
                          <div class="layui-input-inline">
                              <input type="text" name="xueshengjiuyeXinziStart" id="xueshengjiuyeXinziStart"  lay-skin="double"   placeholder="就业薪资/月开始" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          <div class="layui-input-inline" style="margin-top: -5px">
                              <input type="text" name="xueshengjiuyeXinziEnd"   id="xueshengjiuyeXinziEnd"    lay-skin="double|xueshengjiuyeXinziEnd"   placeholder="就业薪资/月结束" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    ...
    // 当前表的字典表
        ...
        form.verify({
            ...
            ,xueshengjiuyeXinziEnd: function(value, item){ //value：表单的值、item：表单的DOM对象
                var xueshengjiuyeXinziStart = $("#xueshengjiuyeXinziStart").val();
                if(xueshengjiuyeXinziStart != null && xueshengjiuyeXinziStart != "" && xueshengjiuyeXinziStart != "null"){
                    var number = parseInt(value)- parseInt(xueshengjiuyeXinziStart);
                    if(number<0){
                        return '就业薪资/月的结束值不能小于开始值';
                    }
                }
            }
        ...
        function pageList() {
            ...
            if (jquery('#xueshengjiuyeUuidNumber').val() != null && jquery('#xueshengjiuyeUuidNumber').val() != "" && jquery('#xueshengjiuyeUuidNumber').val() != "null" ) {
                param['xueshengjiuyeUuidNumber'] = jquery('#xueshengjiuyeUuidNumber').val();
            }
         
            if (jquery('#xueshengjiuyeAddress').val() != null && jquery('#xueshengjiuyeAddress').val() != "" && jquery('#xueshengjiuyeAddress').val() != "null" ) {
                param['xueshengjiuyeAddress'] = jquery('#xueshengjiuyeAddress').val();
            }
         
            if (jquery('#xueshengjiuyeGongsi').val() != null && jquery('#xueshengjiuyeGongsi').val() != "" && jquery('#xueshengjiuyeGongsi').val() != "null" ) {
                param['xueshengjiuyeGongsi'] = jquery('#xueshengjiuyeGongsi').val();
            }
         
            if (jquery('#xueshengjiuyeZhiwei').val() != null && jquery('#xueshengjiuyeZhiwei').val() != "" && jquery('#xueshengjiuyeZhiwei').val() != "null" ) {
                param['xueshengjiuyeZhiwei'] = jquery('#xueshengjiuyeZhiwei').val();
            }
         
            if (jquery('#xueshengjiuyeXinziStart').val() != null && jquery('#xueshengjiuyeXinziStart').val() != "" && jquery('#xueshengjiuyeXinziStart').val() != "null" ) {
                param['xueshengjiuyeXinziStart'] = jquery('#xueshengjiuyeXinziStart').val();
            }
            if (jquery('#xueshengjiuyeXinziEnd').val() != null && jquery('#xueshengjiuyeXinziEnd').val() != "" && jquery('#xueshengjiuyeXinziEnd').val() != "null" ) {
                param['xueshengjiuyeXinziEnd'] = jquery('#xueshengjiuyeXinziEnd').val();
            }
                                

            // 获取列表数据
            http.request('xueshengjiuye/list', 'get', param, function(res) {
