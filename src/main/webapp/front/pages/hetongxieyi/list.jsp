        ...
        <div class="ng-inmod ng-fault ng-paddor ng-bg-fff">
            <div class="ng-inmod-ini">
                    <div class="index_titlebox">
                        <h3 class="index_title">合同协议展示</h3>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="hetongxieyiUuidNumber" id="hetongxieyiUuidNumber" placeholder="协议编号" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="hetongxieyiBiaoti" id="hetongxieyiBiaoti" placeholder="协议标题" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <select name="hetongxieyiTypes" id="hetongxieyiTypes" lay-filter="hetongxieyiTypes">
                                  <option value="">--请选择--</option>
                                  <option v-for="item in hetongxieyiTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
                              </select>
                          </div>
                      </div>
...
<script>
    var vue = new Vue({
        ...
        data: {
            ...
            dataList: [],//数据
        // 当前表字典表数据
            hetongxieyiTypesList : [],
            hetongxieyiTypes: 0,//类型
            limit: 8,
    ...
    // 当前表的字典表
        ...
        function hetongxieyiTypesSelect() {
            http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=hetongxieyi_types", 'get', {}, function (res) {
                if(res.code == 0){
                    vue.hetongxieyiTypesList = res.data.list;
                }
            });
        }
        ...
        function pageList() {
            ...
            if (jquery('#hetongxieyiUuidNumber').val() != null && jquery('#hetongxieyiUuidNumber').val() != "" && jquery('#hetongxieyiUuidNumber').val() != "null" ) {
                param['hetongxieyiUuidNumber'] = jquery('#hetongxieyiUuidNumber').val();
            }
                         
            if (jquery('#hetongxieyiBiaoti').val() != null && jquery('#hetongxieyiBiaoti').val() != "" && jquery('#hetongxieyiBiaoti').val() != "null" ) {
                param['hetongxieyiBiaoti'] = jquery('#hetongxieyiBiaoti').val();
            }
         
            var hetongxieyiTypes = $("#hetongxieyiTypes").find("option:selected").val();
            if (hetongxieyiTypes != null && hetongxieyiTypes != "" && hetongxieyiTypes != "null") {
                param['hetongxieyiTypes'] = hetongxieyiTypes;
            }
                                        

            // 获取列表数据
            http.request('hetongxieyi/list', 'get', param, function(res) {
