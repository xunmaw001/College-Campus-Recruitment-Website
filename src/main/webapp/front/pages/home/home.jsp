    ...
    <div class="ng-container ng-fault">
        ...
        <div class="ng-inmod ng-fault ng-paddor ng-bg-assist">
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="show-reel">
                        <div v-for="(item,index) in zhaopinList" v-bind:key="index" class="col-md-3 agile-gallery-grid">
                            <div class="agile-gallery">
        ...
        <div class="ng-inmod ng-fault ng-paddor ng-bg-assist">
            <div class="ng-inmod-ini">
                    <div class="index_titlebox">
                        <h3 class="index_title">公司展示</h3>
                        <p class="index_intro">DATA SHOW</p>
                    </div>
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="show-reel">
                        <div v-for="(item,index) in gongsiList" v-bind:key="index" class="col-md-3 agile-gallery-grid">
                            <div class="agile-gallery">
                                <a @click="jumpCheck('../gongsi/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)" class="lsb-preview" data-lsb-group="header">
                                    <img :src="item.gongsiPhoto?item.gongsiPhoto.split(',')[0]:''" style="height: 350px;width:100%;" />
                                    <div class="agileits-caption">
                                        <h4>{{item.gongsiName}}</h4>
                                        <p v-if="item.gongsiNewMoney != null" >￥{{item.gongsiNewMoney}}</p>
                                    </div>
                                </a>
                            </div>
                        </div>
        ...
        <div class="ng-inmod ng-fault ng-paddor ng-bg-assist">
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="show-reel">
                        <div v-for="(item,index) in zhaopinhuiList" v-bind:key="index" class="col-md-3 agile-gallery-grid">
                            <div class="agile-gallery">
...
<script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function () {
        ...
        http.request(`gongsi/list`, 'get', {
            page: 1,
            limit: 8,
            gongsiDelete: 1,
        }, function (res) {
            vue.gongsiList = res.data.list;
        });
        http.request(`zhaopinhui/list`, 'get', {
            page: 1,
            limit: 8,
        }, function (res) {
            vue.zhaopinhuiList = res.data.list;
        });
    });
</script>
