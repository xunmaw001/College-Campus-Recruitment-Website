            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑简历投递</li>
                    </ol>
                </div>
            </div>
        </div>
...
<script>
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            httpJson("toudi/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
    ...
    // 获取当前详情
    function getDetails() {
        var addtoudi = window.sessionStorage.getItem("addtoudi");
        if (addtoudi != null && addtoudi != "" && addtoudi != "null") {
            //注册表单验证
            $(validform());
            ...
            window.sessionStorage.removeItem('updateId');
            http("toudi/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
