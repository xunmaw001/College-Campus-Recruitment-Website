...
<!--/Pre Loader -->
                            ...
                            <div class="table-responsive mb-3">
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        所在行业
                                        <div class="layui-input-inline">
                                            <select name="hanyeTypesSelectSearch"  style="width: 150px;" id="hanyeTypesSelectSearch" class="form-control form-control-sm"
    ...
    <!-- 本表的查询条件 -->
        ...
        function setDataRow(item, number) {
            ...
            //所在行业
            var hanyeTypesCell = document.createElement('td');
            hanyeTypesCell.innerHTML = item.hanyeValue;
            row.appendChild(hanyeTypesCell);
            ...
            //邮箱
            var gongsiEmailCell = document.createElement('td');
            gongsiEmailCell.innerHTML = item.gongsiEmail;
            row.appendChild(gongsiEmailCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("gongsi/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addgongsi", "addgongsi");
            window.location.href = "add-or-update.jsp"
        }
