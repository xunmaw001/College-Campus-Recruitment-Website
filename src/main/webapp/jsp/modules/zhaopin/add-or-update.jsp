                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="gongsiId" name="gongsiId" type="hidden">
                                    <div class="form-group col-md-6 zhaopinNameDiv">
                                        <label>招聘信息名称</label>
                                        <input style="width: 450px" id="zhaopinName" name="zhaopinName" class="form-control"
                                               placeholder="招聘信息名称">
                                    </div>
                                    <div class="form-group col-md-6 zhaopinPhotoDiv">
                                        <label>招聘信息照片</label>
                                    ...
                                    <div class="form-group col-md-6 zhaopinDaiyuDiv">
                                        <label>薪资待遇</label>
                                        <input style="width: 450px" id="zhaopinDaiyu" name="zhaopinDaiyu" class="form-control"
                                               placeholder="薪资待遇">
                                    </div>
                                    <div class="form-group col-md-6 zhaopinAddressDiv">
                                        <label>上班地点</label>
                                        <input style="width: 450px" id="zhaopinAddress" name="zhaopinAddress" class="form-control"
                                               placeholder="上班地点">
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 zhaopinPhoneDiv">
                                        <label>招聘电话</label>
                                        <input style="width: 450px" id="zhaopinPhone" name="zhaopinPhone" class="form-control"
                                               onchange="zhaopinPhoneChickValue(this)"  placeholder="招聘电话">
                                    </div>
                                    <div class="form-group col-md-6 zhaopinTypesDiv">
                                        <label>招聘岗位</label>
                                        <select style="width: 450px" id="zhaopinTypesSelect" name="zhaopinTypes" class="form-control">
                                        </select>
                                    </div>
                                    <div class="form-group col-md-6 zhaopinRenshuNumberDiv">
                                        <label>招聘人数</label>
                                        <input style="width: 450px" id="zhaopinRenshuNumber" name="zhaopinRenshuNumber" class="form-control"
                                               onchange="zhaopinRenshuNumberChickValue(this)"  placeholder="招聘人数">
                                    </div>

                                    <div class="form-group  col-md-6 zhaopinContentDiv">
                                        <label>招聘信息详情</label>
    ...
    function getContent() {
        ...
        if($("#zhaopinContentupload").length>0) {
            ...
            if (zhaopinContentEditor.hasContents()) {
                $('#zhaopinContent-input').attr('value', zhaopinContentEditor.getContent());
            }
        }
    }
    //数字检查
        <!-- 当前表的数字检查 -->
        function zhaopinPhoneChickValue(e){
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                ...
                zhaopinDaiyu: "required",
                zhaopinAddress: "required",
                lianxirenName: "required",
                zhaopinPhone: "required",
                zhaopinTypes: "required",
                zhaopinRenshuNumber: "required",
                shangxiaTypes: "required",
                zhaopinContent: "required",
            },
            messages: {
                gongsiId: "公司不能为空",
                zhaopinName: "招聘信息名称不能为空",
                zhaopinPhoto: "招聘信息照片不能为空",
                zhaopinDaiyu: "薪资待遇不能为空",
                zhaopinAddress: "上班地点不能为空",
                lianxirenName: "联系人不能为空",
                zhaopinPhone: "招聘电话不能为空",
                zhaopinTypes: "招聘岗位不能为空",
                zhaopinRenshuNumber: "招聘人数不能为空",
                shangxiaTypes: "是否上架不能为空",
                zhaopinContent: "招聘信息详情不能为空",
            }
        }).form();
    }
