...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">邀请面试管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">邀请面试列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">邀请面试列表</h3>
    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            //面试地点
            var mianshiAddressCell = document.createElement('td');
            mianshiAddressCell.innerHTML = item.mianshiAddress;
            row.appendChild(mianshiAddressCell);


            //面试需知
            var mianshiTextCell = document.createElement('td');
            mianshiTextCell.innerHTML = item.mianshiText;
            row.appendChild(mianshiTextCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("yaoqing/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addyaoqing", "addyaoqing");
            window.location.href = "add-or-update.jsp"
        }
