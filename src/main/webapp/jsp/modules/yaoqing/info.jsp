            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">邀请面试登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input style="width: 450px" id="zhaopinPhone" name="zhaopinPhone" class="form-control"
                                                   v-model="ruleForm.zhaopinPhone" readonly>
                                        </div>
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="jianliId" name="jianliId" v-model="ruleForm.jianliId" readonly type="hidden">
                                <input id="zhaopinId" name="zhaopinId" v-model="ruleForm.zhaopinId" readonly type="hidden">

                                    <div class="form-group col-md-6">
                                        <label>面试时间</label>
                                        <input style="width: 450px" id="mianshiTime" name="mianshiTime" class="form-control"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="mianshiAddress" name="mianshiAddress" class="form-control"
                                               v-model="ruleForm.mianshiAddress" readonly>
                                    </div>


                                    <div class="form-group col-md-6">
                                        <label>面试需知</label>
                                        <input style="width: 450px" id="mianshiText" name="mianshiText" class="form-control"
                                               v-model="ruleForm.mianshiText" readonly>
                                    </div>
