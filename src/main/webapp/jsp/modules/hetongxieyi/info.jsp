            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">合同协议登记</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <!-- 本表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="hetongxieyiUuidNumber" name="hetongxieyiUuidNumber" class="form-control"
                                               v-model="ruleForm.hetongxieyiUuidNumber" readonly>
                                    </div>

                                <input id="gongsiId" name="gongsiId" v-model="ruleForm.gongsiId" readonly type="hidden">
                                <input id="xueshengId" name="xueshengId" v-model="ruleForm.xueshengId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="hetongxieyiBiaoti" name="hetongxieyiBiaoti" class="form-control"
                                               v-model="ruleForm.hetongxieyiBiaoti" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>协议类型</label>
                                    <input style="width: 450px" id="hetongxieyiValue" name="hetongxieyiValue" class="form-control"
                                           v-model="ruleForm.hetongxieyiValue" readonly>
                                </div>

                                    <div class="form-group col-md-6">
                                        <label>协议签订时间</label>
                                        <input style="width: 450px" id="qiandingTime" name="qiandingTime" class="form-control"
...
<script>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "hetongxieyi/info/" + id,
    ...
    function setContent() {
        ...
        if (ruleForm.hetongxieyiContent != null && ruleForm.hetongxieyiContent != 'null' && ruleForm.hetongxieyiContent != '') {
            var hetongxieyiContentUeditor = UE.getEditor('hetongxieyiContentEditor');
                hetongxieyiContentUeditor.ready(function () {
                    ...
                    hetongxieyiContentUeditor.setDisabled('fullscreen');
            });
        }
    }
    ...
    function setDownloadBtn() {
        var hetongxieyiFileUrl = "download('" + ruleForm.hetongxieyiFile + "')";
        $("#hetongxieyiFile").attr("onclick", hetongxieyiFileUrl);
